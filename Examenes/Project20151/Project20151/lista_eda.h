...
public:
    ...
    void doblarlista() {
        int i = 1;
        Nodo* detras = this->fantasma->ant;
        Nodo* delante = this->fantasma->sig;
        Nodo* actual = detras;
        Nodo* siguiente;

        while (delante->sig != this->fantasma && delante->sig->sig != this->fantasma) {
            siguiente = delante->sig;
            actual = detras;
            detras = detras->ant;
            delante->sig = actual;
            actual->ant = delante;
            ...
            actual->sig = delante;
            delante->ant = actual;
            detras->sig = this->fantasma;
            this->fantasma->ant = detras;
        }
    }

    void estremece() {

        auto delante = this->fantasma->sig, detras = this->fantasma, actual = delante->sig, siguiente = actual->sig;;
        int i = 1;
