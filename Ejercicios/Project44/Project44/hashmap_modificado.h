...
#ifndef hashmap_modificado_h
#define hashmap_modificado_h
...
template <class Clave, class Valor,
        ...
        protected:
            ...
            Iterador(pointer_tabla t, Clave const& c) : tabla(t) {
                ...
                if (!tabla->localizar(c, ant, act)) { // se devuelve iterador al final
                    ant = act = nullptr; ind = tabla->array.size();
                }
            }
    ...
    public:
        ...
        iterator erase(iterator const& it) {
            ...
            iterator sol = it;
            ++sol;
            if (sol.ind == it.ind) sol.ant = it.ant;
            Link a_borrar = it.act;
            if (it.ant != nullptr) {
               // it.ant.sig = it.act.sig;
            }
//            else array[it.ind] = it.act.sig;
            delete a_borrar;
            return sol;
        }
